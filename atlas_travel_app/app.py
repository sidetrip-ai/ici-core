#!/usr/bin/env python3
"""
Flask backend for CryptoTravel AI - A tech-savvy interface for travel planning
"""
...
6. A 5-day itinerary that balances conference attendance and exploration"""
        ...
        # Note: In test_perplexity.py, both params are passed to plan_travel()
